...
#注意：此时路径前两行为linux系统路径格式，后面两行是windows路径格式。
   # img_path, xml_path = '/media/数据备份/data_new/JPEGImages/', '/media/xhh/数据备份/data_new/Annotations/'
    ...
    img_path = r'E:\2_Tang\work\Recognize\weibolu\210712ten_thousand_seg_data\temp_img'
    xml_path = r'E:\2_Tang\work\Recognize\weibolu\210712ten_thousand_seg_data\temp_xml'
    save_img_path = r'E:\2_Tang\work\Recognize\weibolu\210712ten_thousand_seg_data\1'
    save_xml_path = r'E:\2_Tang\work\Recognize\weibolu\210712ten_thousand_seg_data\2'
    ...
    for file in os.listdir(img_path):
        ...
        #flip(image, xml, 'Up_Bottom', save_img_path, save_xml_path, standardize(counter+1), format,filename)
        #flip(image, xml, 'Left_Right', save_img_path, save_xml_path, standardize(counter+1), format,filename)
